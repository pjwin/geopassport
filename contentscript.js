...
const documentObserverCallback = function (mutations) {
  mutations.forEach(function (mutation) {
    if (mutation.addedNodes.length) {
      mutation.addedNodes.forEach(function (node) {
        if (node.className === "game-state-overview__wrong-guesses") {
...
// document.contains(document.getElementsByClassName("wrong-guesses__flag")[0])
